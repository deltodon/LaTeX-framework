...
\makeatletter
	...
	\g@addto@macro\input@path{{../framework/}}	% append
\makeatother

\usepackage{imakeidx}
\makeindex[intoc, options={-s ../framework/dtn-indexstyle}]


\usepackage{dissertation-layout}
...
% uncomment the line bellow and update the path
\addlogo{logos/Abertay.png}
...
\printbibliography[title={List of References},category=cited]
\pagebreak
